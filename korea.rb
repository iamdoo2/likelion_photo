...
teachers = [
  ["민종현", "고려대 컴퓨터교육과", "korea/t1.jpg","{{너가 원하던거 나 고친 지금에야 넌 어디로 갔는지}}"],
  ["구동현", "고려대 컴퓨터학과", "korea/t2.jpg","{{너무 어려워 날 몰라주는 너도 서러워}}"],
  ["강원준", "고려대 경영학과", "korea/t3.jpg","{{널 잊으려고 노력해봐도 잘 안되 너 미워하는건}}"],
  ["남상준", "고려대 컴퓨터학과", "korea/t4.jpg","{{널 기다리는 밤 처럼 길고 어둡던 우리 사이 공백}}"],
  ["이상윤", "고려대 컴퓨터학과", "korea/t5.jpg","{{officially missing you}}"]
].suffle
