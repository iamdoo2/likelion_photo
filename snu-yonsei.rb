...
teaachers = [
	["홍지호", "연세대학교 컴퓨터과학과", "snu-yonsei/t1.jpg", "한마디"],
	["박준호", "서울대학교 컴퓨터공학부", "snu-yonsei/t1.jpg", "한마디"],
	["한영후", "Georgia Tech Computer Science", "snu-yonsei/t1.jpg", "한마디"],
	["남다예", "연세대학교 컴퓨터과학과", "snu-yonsei/t1.jpg", "한마디"]
].shuffle
students = [
	...
	["노승은", "서울대학교 자유전공학부(컴퓨터공학/경제학)", 	"snu-yonsei/s5.jpg" ],
	...
	["이혜리", "숙명여자대학교 멀티미디어과학과","snu-yonsei/s14.jpg"],
	["정승완", "중앙대학교 정치국제학과", 		"snu-yonsei/s15.jpg"],
	["정우주", "연세대학교 정보산업공학과", 	"snu-yonsei/s16.jpg"],
	["조경욱", "서울대학교 시각디자인", 		"snu-yonsei/s17.jpg"],
	["천현정", "이화여자대학교 약학과",			"snu-yonsei/s18.jpg"],
